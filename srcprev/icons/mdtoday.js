...
const mdtoday = props => (
		...
		<Svg width={props.size} height={props.size} fill={props.color} viewBox="0 0 512 512">
			...
			<Path d="M145 194v204c0 1.1.9 2 2 2h218c1.1 0 2-.9 2-2V194c0-1.1-.9-2-2-2H147c-1.1 0-2 .9-2 2zm0-79.3v34c0 1.1.9 2 2 2h171c1.1 0 2-.9 2-2v-34c0-1.1-.9-2-2-2H147c-1.1 0-2 .9-2 2z" />
		</Svg>
