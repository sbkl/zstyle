...
const iosfiling = props => (
    ...
    <Svg width={props.size} height={props.size} fill={props.color} viewBox="0 0 512 512">
      ...
      <Path d="M386 156H126c-7.7 0-14-6.3-14-14s6.3-14 14-14h260c7.7 0 14 6.3 14 14s-6.3 14-14 14zm0 64H126c-7.7 0-14-6.3-14-14s6.3-14 14-14h260c7.7 0 14 6.3 14 14s-6.3 14-14 14z" />
    </Svg>
  </ZView>
)
